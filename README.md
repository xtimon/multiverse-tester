...
**Главное открытие (Закон 8D):** допустимый диапазон изменения константы обратно пропорционален силе соответствующего взаимодействия — ΔP ∝ 1/F.
...
- **α** — единственный параметр с чётким оптимумом (~0.007–0.011), близок к нашей Вселенной
- **m_p, m_e, ε₀, k_B** — стабилизируются на ~0.1× (могут быть в 10 раз меньше)
- **c, ħ** — стабилизируются на ~0.2× (могут быть в 5 раз меньше)
